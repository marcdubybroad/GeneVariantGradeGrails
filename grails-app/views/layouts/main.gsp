...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"><!--<![endif]-->
	...
	<body>
        ...
        <div>Software version 0.29. Data version 1.0.</div>
        <div>Copyright Reserved 2016. All rights reserved.</div>
        <div>This software is supplied without warranty or guaranteed support. No responsibility is assumed by the authors for responsible for its use, misuse, or functionality.</div>
        </div>
	</body>
</html>
